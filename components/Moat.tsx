      ...
      <div className="mx-auto max-w-4xl px-6 py-20 md:py-24">
        ...
        <div className="mt-8 space-y-6 text-lg leading-relaxed text-[color:var(--color-sjc-ink)]">
          ...
          <Editable tid="home.moat.p3" as="p">
            I'm both. I opened my first shop in 1986 — a restaurant — then mortgage, then roofing, then twenty years in trucking. Four businesses of my own, and the tech lead in every one, because we were too small to afford anyone else. And now I build the AI myself. Not a deck I bought, not a vendor I white-label. I sit on top of my own AI workforce and I build it by hand. So when I sit across from you, I'm not the tech guy you tolerate — I'm a man who ran shops just like yours for four decades and happens to be the one who can install the machine. You believe me because I've stood where you're standing. That overlap — real operator and hands-on builder — is the moat. There's no one to send you to bid against, because the two halves almost never come in one person.
          </Editable>
        </div>
      </div>
    </section>
