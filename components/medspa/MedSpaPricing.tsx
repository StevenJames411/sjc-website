    ...
    <section className="bg-white">
      <div className="mx-auto max-w-5xl px-6 py-20 md:py-24">
        ...
        <div className="mt-8 space-y-6 text-lg leading-relaxed text-[color:var(--color-sjc-ink)]">
          <Editable tid="medspa.expansion.p1" as="p">
          ...
          <p>
            <strong><Editable tid="medspa.expansion.p2.bold1" as="span">The build</Editable></strong>
            {" "}<Editable tid="medspa.expansion.p2.mid" as="span">is a one-time install.</Editable>{" "}
            <strong><Editable tid="medspa.expansion.p2.bold2" as="span">A flat monthly</Editable></strong>
            {" "}<Editable tid="medspa.expansion.p2.end" as="span">keeps it running, monitored, and improving — the same way you already pay for the software you run on. Standard, and simple. You see the full number before anything gets built.</Editable>
          </p>
        </div>
