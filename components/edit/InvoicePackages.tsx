...
const panel: React.CSSProperties = { border: "1px solid #e5e7eb", borderRadius: 12, padding: 20, background: "#fff", marginTop: 16 };
...
const hint: React.CSSProperties = { fontSize: 12.5, color: "#6b7280", marginTop: 3, lineHeight: 1.5, maxWidth: 560 };
const row: React.CSSProperties = { border: "1px solid #e5e7eb", borderRadius: 10, padding: 14, background: "#fcfcfd" };
...
const clearBtn: React.CSSProperties = { background: "none", border: "none", color: "#9ca3af", fontSize: 12, fontWeight: 600, cursor: "pointer", padding: 0 };
const clearOn: React.CSSProperties = { ...clearBtn, color: "#b91c1c" };
const saveState: React.CSSProperties = { fontSize: 12.5, color: "#6b7280", fontWeight: 600 };
const errBox: React.CSSProperties = { background: "#fef2f2", border: "1px solid #fecaca", color: "#b91c1c", borderRadius: 8, padding: "9px 12px", fontSize: 13, marginBottom: 14 };
