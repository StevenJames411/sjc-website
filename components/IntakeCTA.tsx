...
export default function IntakeCTA() {
  return (
    <section id="book" className="scroll-mt-20" style={{ backgroundColor: "#1e3a6e" }}>
      <div className="mx-auto max-w-3xl px-6 py-20 text-center md:py-24">
        <h2 className="text-3xl font-bold leading-tight tracking-tight text-white md:text-4xl">
          Put AI to work on top of the business you already built.
        </h2>
        <p className="mt-5 text-xl leading-relaxed text-white/90 md:text-2xl">
          Speed to lead and a dynamic AI workforce, installed on your systems &mdash; and
          you keep control. Book the call and we&apos;ll map where the gap is.
        </p>
