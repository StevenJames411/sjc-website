...
export const PLAYBOOK_DEFAULTS: PlaybookProps = {
  ...
  p5: "That's the playbook, top to bottom. I'm not here to tell you it's wrong. I'm here because I know it well enough to show you where the lid is — and the new lever that lifts it.",
};
