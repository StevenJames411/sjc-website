...
export const PROOF_DEFAULTS: ProofProps = {
  ...
  p1: "None of this is a whiteboard theory, and I'm not going to ask you to take a forty-year operator's word for it without a receipt. There's a working prototype running right now, in one field, and it's the first of many.",
  p2: "The field is med spas. The AI employee has a name — Chloe. She's trained on the owner's own sales conversations: the way he actually talks to a lead, the questions he asks, the way he handles “let me think about it.” She answers every lead the instant it lands and books the consult herself, start to finish, no human in the loop. Her first night live was a Sunday, staff off — she booked four consults while the lights were out and nobody was at the desk. Four appointments that, the week before, would have sat in a voicemail box until Monday.",
