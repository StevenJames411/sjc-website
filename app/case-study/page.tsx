...
const DID = [
  {
    ...
    body: "A lead fills out the form at 9:47 on a Sunday night. Before, it sat in the CRM until Monday morning &mdash; cold, or gone to a competitor. Now it gets a real reply in seconds, every time, day or night.",
  },
  {
      ...
      <main>
        ...
        <section style={{ backgroundColor: "#f3f4f6" }} className="w-full">
          <div className="mx-auto max-w-4xl px-6 py-16 md:py-24">
            ...
            <p className="mt-6 text-lg leading-relaxed text-[color:var(--color-sjc-ink)] md:text-xl">
              You don&apos;t have to take my word for what a dynamic AI employee does. Here&apos;s
              one already doing it &mdash; in a real business, with real leads, on a Sunday night.
            </p>
          </div>
        </section>
        ...
        <section className="bg-white">
          <div className="mx-auto max-w-3xl px-6 py-16 md:py-20">
            ...
            <div className="mt-6 space-y-5 text-base leading-relaxed text-[color:var(--color-sjc-ink)] md:text-lg">
              <p>
                A med spa was running paid ads and getting plenty of leads. The problem was the
                same one almost every owner has. Leads filled out the form, landed in the CRM, and
                sat there. By the time someone got around to calling, the lead had gone cold &mdash;
                or already booked somewhere else.
              </p>
              <p>
                They&apos;d already tried the usual fix: an automated email-and-text follow-up that
                fired off a few canned messages and stopped. That&apos;s step one &mdash; a script
                that waits. It helps a little, then runs out of road. It can&apos;t hold a real
                conversation, can&apos;t answer a question, and can&apos;t get anyone onto the
                calendar. It just waits.
              </p>
            </div>
          </div>
        </section>
        ...
        <section style={{ backgroundColor: "#f3f4f6" }} className="w-full">
          <div className="mx-auto max-w-3xl px-6 py-16 md:py-20">
            ...
            <div className="mt-6 space-y-5 text-base leading-relaxed text-[color:var(--color-sjc-ink)] md:text-lg">
              <p>
                We took the owner&apos;s own sales conversations &mdash; how he answers questions,
                how he handles the price objection, how he talks to people &mdash; and trained an
                AI employee on all of it. We named her Chloe.
              </p>
              <p>
                This is step two. Not a script that waits for someone to reply. An employee that
                goes to work: she answers the lead, holds a real back-and-forth, handles objections
                in the owner&apos;s own words, and books the appointment herself. She sounds like the
                owner trained her &mdash; because he did, through his own recordings.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-4xl px-6 py-16 md:py-20">
            ...
            <div className="mt-8 space-y-6">
              {DID.map((d) => (
                ...
                >
                  ...
                  <p
                    className="mt-3 text-base leading-relaxed text-[color:var(--color-sjc-ink)] md:text-lg"
            ...
            <div className="mt-12 grid gap-5 md:grid-cols-3">
              {RECEIPTS.map((r) => (
                ...
                >
                  <p className="text-2xl font-bold text-[color:var(--color-sjc-blue)] md:text-3xl">
                    {r.value}
                  </p>
                  <p
        ...
        <section style={{ backgroundColor: "#f3f4f6" }} className="w-full">
          <div className="mx-auto max-w-3xl px-6 py-16 md:py-20">
            ...
            <div className="mt-6 space-y-5 text-base leading-relaxed text-[color:var(--color-sjc-ink)] md:text-lg">
              <p>
                Chloe runs on top of the business the owner already had. His CRM. His calendar. His
                leads. His pricing. Nothing got ripped out and nothing got taken away. I operate the
                plumbing in the background so he doesn&apos;t have to &mdash; and he can watch every
                conversation and every booking as it happens.
              </p>
              <p className="font-semibold">
                That&apos;s the whole idea. You become the AI-first company, the machine does the
                work, and your hand stays on every lead and every dollar.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white">
          <div className="mx-auto max-w-3xl px-6 py-16 text-center md:py-20">
            ...
            <p className="mt-4 text-base leading-relaxed text-[color:var(--color-sjc-ink)] md:text-lg">
              Book a quick call. I&apos;ll show you exactly where a dynamic AI employee plugs into
