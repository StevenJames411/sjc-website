...
export const DELIVERABLES: Deliverable[] = [
  ...
  { id: "crm.a2p", title: "A2P brand and campaign registration", product: "crm", phase: 1, owner: "client", needs: ["legalName", "ein", "entityType", "registeredAddress", "authorizedRep"],
    how: "A2P brand and campaign. ⛔ The carriers check every field against public records — one wrong character sends it back to the start of a multi-week queue, and every text, reminder and follow-up waits behind it. Start day one, verify before submitting." },
